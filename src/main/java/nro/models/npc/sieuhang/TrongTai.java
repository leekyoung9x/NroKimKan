package nro.models.npc.sieuhang;
...
//        lock.readLock().lock();
//        try {
//            Zone zone = SieuHang.getMapChalllenge(ConstMap.DAI_HOI_VO_THUAT_113);
//            if (zone != null) {
//                Player pl = SieuHangManager.LoadPlayerByID();
//                if (pl == null) {
